...
class Contact {
    ...
    public long followers(){return this.followers();}

    public void setFriends(List<String> friends){this._friends = new HashSet<>(friends); this._followers = this._friends.size();}
    public List<String> getFriends(){return new ArrayList<String>(this._friends);}
    public void addFriend(String friend){this._friends.add(friend); this._followers++;}
    public void removeFriend(String friend){this._friends.remove(friend); this._followers--;}
...
*/
    ...
    public String toString() {
        ...
        builder.append(this._emails.toString()).append(";");
        builder.append(this._followers + " Followers").append(";");
